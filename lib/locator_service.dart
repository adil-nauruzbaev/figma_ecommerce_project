...
import 'package:figma_ecommerce_project/features/cart/data/repositories/cart_repository_impl.dart';
...
import 'package:figma_ecommerce_project/features/home/data/repositories/home_repository_impl.dart';
import 'package:figma_ecommerce_project/features/home/domain/repositories/home_repository.dart';
import 'package:figma_ecommerce_project/features/home/domain/usecases/get_all_store.dart';
...
import 'package:figma_ecommerce_project/features/product/data/repositories/product_repository_impl.dart';
...
Future<void> initializeDependencies() async {
  ...
  injection.registerFactory(() => ProductBloc(getAllProductsUseCase: injection()));
 

  injection.registerLazySingleton(() => GetAllStoreUseCase(injection()));
  injection.registerLazySingleton(() => GetAllCartsUseCase(injection()));
  injection.registerLazySingleton(() => GetAllProductsUseCase(injection()));
  ...
  injection.registerLazySingleton<ProductDataSource>(() => ProductDataSourceImpl(client: http.Client()));
